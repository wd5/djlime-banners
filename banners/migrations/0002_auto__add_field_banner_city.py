...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Banner.city'
        db.add_column('banners_banner', 'city',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['location.City'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Banner.city'
        db.delete_column('banners_banner', 'city_id')
